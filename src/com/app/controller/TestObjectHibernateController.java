...
import src.com.app.service.TestObjectHibernateService;
...
public class TestObjectHibernateController {

    private final TestObjectHibernateService TEST_OBJECT_SERVICE;

    private TestObjectHibernateController(TestObjectHibernateService testObjectService) {
